 ...
 * @since 1.0
 */
final class ProjogDouble extends ProjogTerm implements PrologDouble {

	ProjogDouble(PrologProvider provider, Number value) {
		super(DOUBLE_TYPE, provider, new DecimalFraction(value.doubleValue()));
	}
